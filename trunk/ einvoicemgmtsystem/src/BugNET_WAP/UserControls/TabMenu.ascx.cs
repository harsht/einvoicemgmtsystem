    ...
    public partial class TabMenu : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (CurrentMenuType == MenuType.Project)
            {
                ...
                Tabs.Add(new Tab("Calendar", string.Format("~/Projects/ProjectCalendar.aspx?pid={0}",ProjectId)));
                Tabs.Add(new Tab("Roadmap",  string.Format("~/Projects/Roadmap.aspx?pid={0}",ProjectId)));
                Tabs.Add(new Tab("Change Log",  string.Format("~/Projects/ChangeLog.aspx?pid={0}",ProjectId)));
            ...
            if (Context.User.Identity.IsAuthenticated)
            {
                ...
                else if(ITUser.IsInRole(Globals.DefaultRoles[0]))
                    Tabs.Add(new Tab(GetLocalResourceObject("Admin").ToString(), "~/Administration/Admin.aspx"));
            }        
