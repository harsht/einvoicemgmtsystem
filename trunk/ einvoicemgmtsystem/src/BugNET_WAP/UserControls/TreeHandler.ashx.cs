...
namespace BugNET.UserControls
{
    ...
    public class TreeHandler : IHttpHandler
    {
        ...
        { 
            ...
            if (context.User.Identity == null || !context.User.Identity.IsAuthenticated || (!ITUser.IsInRole(context.User.Identity.Name, ProjectId, "Administrators") && !ITUser.IsInRole(context.User.Identity.Name, 0, "Super Users")))
