            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                switch (currentField.FieldType)
                {
                    case CustomField.CustomFieldType.DropDownList:
                        ...
                        ddl.DataSource = CustomFieldSelection.GetCustomFieldsSelectionsByCustomFieldId(currentField.Id);
                    ...
                    case CustomField.CustomFieldType.UserList:
                        ...
                        ddl.ID = FIELD_VALUE_NAME;
                        ddl.DataSource = ITUser.GetUsersByProjectId(currentField.ProjectId);
                        ddl.DataBind();
                        ddl.Items.Insert(0, "-- Select One --");
                        ddl.SelectedValue = currentField.Value;
                        ph.Controls.Add(ddl);
