        ...
        protected override void  OnPreRender(EventArgs e)
        {
            ...
            switch (_MessageType)
            {
                case MessageType.Information:
                    MessageIcon.ImageUrl = "~/Images/information.gif";
                    MessageContainer.CssClass = "message-info";
                    break;
                case MessageType.Error:
                    MessageIcon.ImageUrl = "~/Images/exclamation.gif";
                    MessageContainer.CssClass = "message-error";
                    break;
                case MessageType.Warning:
                    MessageIcon.ImageUrl = "~/Images/error.gif";
                    MessageContainer.CssClass = "message-warn";
                    break;
            }
        }

        /// <summary>
        /// Handles the Click event of the HideButton control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
