        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="CreateUserWizardStep0"  runat="server">
                <ContentTemplate>
                    <table border="0">
                        <tr>
                            <td align="left" colspan="2" style="font-weight: bold; font-size: 18px; height: 50px">
                                <asp:Label ID="TitleLabel" meta:resourcekey="TitleLabel" runat="server" Text="Sign up for your new account"></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="EmailRequired"  meta:resourcekey="EmailRequired" runat="server" ControlToValidate="Email"
