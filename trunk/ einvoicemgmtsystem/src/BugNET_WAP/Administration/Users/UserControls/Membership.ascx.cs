...
namespace BugNET.Administration.Users.UserControls
{
    public partial class Membership : System.Web.UI.UserControl
    {
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (user != null)
                {
                    ...
                    ITUser.UpdateUser(user);
                }
                lblError.Text = "The user has been updated successfully.";
            }
            catch
            {
                lblError.Text = "There was an error updating this user.";
        ...
        protected void AuthorizeUser_Click(object sender, EventArgs e)
        {
            ...
            {
                AuthorizeUser(true);
                lblError.Text = "The user has been authorized successfully.";
            }
            catch
            {
                lblError.Text = "There was an error authorizing this user.";
            }
        }
        ...
        protected void UnAuthorizeUser_Click(object sender, EventArgs e)
        {
            ...
            {
                AuthorizeUser(false);
                lblError.Text = "The user has been unauthorized successfully.";
            }
            catch
            {
                lblError.Text = "There was an error unauthorizing this user.";
            }
        }
