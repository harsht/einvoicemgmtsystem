        ...
        <asp:repeater runat="server" id="rptVersions">
                        ...
                        <th colspan="3">
                            <div class="small-box">
                                <p class="small-box-right">
                                    <span class="title"> <asp:literal id="Literal1" runat="server"  meta:resourcekey="MilestonesLabel" /> <span class="small"><asp:Literal ID="Literal2" runat="server" meta:resourcekey="OpenIssues"/> </span></span>
                                </p>
                            </div>
                        </th> 
                    </tr> 
            ...
            <ItemTemplate>
                <tr>
                    <td class="image-column">
                        <bn:TextImage ID="MilestoneImage" runat="server" ImageUrl="~/images/package.gif" ImageDirectory="/Milestone" /> 
                    </td>
                    <td class="item-column"><asp:HyperLink id="HyperLink1" Text='<%# DataBinder.Eval(Container.DataItem, "Name") %>' NavigateUrl='<%# "~/Issues/IssueList.aspx?pid=" + HttpUtility.UrlEncode(ProjectId.ToString()) + "&m=" + HttpUtility.UrlEncode(DataBinder.Eval(Container.DataItem,"Id").ToString()) %>' runat="server" /></asp:LinkButton></td>
            ...
            <FooterTemplate>
                    <tr>
                        ...
                        <td class="item-column"><asp:HyperLink id="HyperLink1" Text="Unscheduled" NavigateUrl='<%# "~/Issues/IssueList.aspx?pid=" + HttpUtility.UrlEncode(ProjectId.ToString()) + "&m=0" %>' runat="server" /></asp:LinkButton></td>
    ...
    <table class="summary">
        <tr>
            <th>
                <div class="small-box">
                    <p class="small-box-right">
	                    <span class="title"><asp:Literal ID="Literal3" runat="server" meta:resourcekey="Categories"/>  <span class="small"><asp:Literal ID="Literal2" runat="server" meta:resourcekey="OpenIssues"/></span> </span>
                    </p>
                </div>
            </th> 
        </tr>
            ...
            <table class="summary" cellspacing="3">
                <tr>
                    <th colspan="2">
                        <div class="small-box">
	                        <p class="small-box-right">
		                       <span class="title"><asp:Literal ID="Literal3" runat="server" meta:resourcekey="ByAssignee"/> <span class="small"><asp:Literal ID="Literal2" runat="server" meta:resourcekey="OpenIssues"/></span></span>
	                        </p>
                        </div>
                    </th> 
                </tr> 
        ...
        <FooterTemplate>
                <tr>
                    <td class="item-column">
                        <asp:LinkButton Runat="server" CommandArgument='-1' ID="Linkbutton1">Unassigned</asp:LinkButton></td>
                ...
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="3">
		                    <div class="small-box">
			                    <p class="small-box-right">
				                   <span class="title"><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Status %>"/></span>
			                    </p>
		                    </div>
	                    </th> 
                    </tr> 
                ...
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="3">
		                    <div class="small-box">
			                    <p class="small-box-right">
				                    <span class="title"><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Priority %>"/></span>
			                    </p>
		                    </div>
	                    </th> 
                    </tr> 
                ...
                <table class="summary" cellspacing="3">
                    <tr>
	                    <th colspan="3">
		                    <div class="small-box">
			                    <p class="small-box-right">
				                    <span class="title"><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CommonTerms, Type %>" /></span>
			                    </p>
		                    </div>
	                    </th> 
                    </tr> 
