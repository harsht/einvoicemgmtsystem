        ...
        public int Compare(Issue x, Issue y) {
          ...
          switch (_sortColumn) {
            ...
            case "Creator":
              ...
              break;
            case "Owner":
              retVal = String.Compare(x.OwnerUserName, y.OwnerUserName, StringComparison.InvariantCultureIgnoreCase);
              break;
            case "Assigned":
              retVal = String.Compare(x.AssignedUserName, y.AssignedUserName, StringComparison.InvariantCultureIgnoreCase);
              break;
            case "LastUpdateUser":
              retVal = String.Compare(x.LastUpdateUserName, y.LastUpdateUserName , StringComparison.InvariantCultureIgnoreCase);
              break;
            case "IssueType":
