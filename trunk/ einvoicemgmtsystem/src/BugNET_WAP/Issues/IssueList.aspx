<%@ Page language="c#" Inherits="BugNET.Issues.IssueList" MasterPageFile="~/Shared/FullWidth.master" Title="Issue List" Codebehind="IssueList.aspx.cs" AutoEventWireup="True" meta:resourcekey="Page" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="PageTitle">
    <div class="centered-content">
		...
		<asp:Button Text="Create New Issue" Class="standardText" 
            Runat="server" id="btnAdd" OnClick="AddIssue" 
	    ...
	    <td align="left">
		   <asp:Label ID="ViewIssuesLabel" runat="server" Text="View Issues:" meta:resourcekey="ViewIssuesLabel"></asp:Label>
            <asp:DropDownList id="dropView" CssClass="standardText" AutoPostBack="True" 
	            ...
	            <asp:ListItem Text="All Issues" Value="All" Selected="True" meta:resourcekey="ListItem5" />
            </asp:DropDownList>
	    </td>
    </tr>
    <tr>      
        <td valign="top"> 	
             <it:DisplayIssues id="ctlDisplayIssues" runat="server" onrebindcommand="IssuesRebind"></it:DisplayIssues>        
        </td>
    </tr>
</table>
