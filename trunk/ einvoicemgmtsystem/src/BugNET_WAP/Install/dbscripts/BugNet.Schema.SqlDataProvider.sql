...
SELECT     dbo.BugNet_Issues.IssueId, dbo.BugNet_Issues.IssueTitle, dbo.BugNet_Issues.IssueDescription, dbo.BugNet_Issues.IssueStatusId, 
                      ...
                      AS ResolutionImageUrl, ISNULL
                          ((SELECT     SUM(Duration) AS Expr1
                              FROM         dbo.BugNet_IssueWorkReports AS WR
                              WHERE     (dbo.BugNet_Issues.IssueId = dbo.BugNet_Issues.IssueId)), 0.00) AS TimeLogged, dbo.BugNet_Issues.Disabled, 
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueMilestoneCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Permission_GetRolePermission]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueNotification_GetIssueNotificationsByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueNotification_DeleteIssueNotification]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueUnscheduledMilestoneCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelections]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_BugNet_ProjectCustomFieldSelections] on [dbo].[BugNet_ProjectCustomFieldSelections]'
GO
ALTER TABLE [dbo].[BugNet_ProjectCustomFieldSelections] ADD CONSTRAINT [PK_BugNet_ProjectCustomFieldSelections] PRIMARY KEY CLUSTERED  ([CustomFieldSelectionId])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelection_GetCustomFieldSelectionById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueTypeCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_GetCategoryById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Queries]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_BugNet_Queries] on [dbo].[BugNet_Queries]'
GO
ALTER TABLE [dbo].[BugNet_Queries] ADD CONSTRAINT [PK_BugNet_Queries] PRIMARY KEY CLUSTERED  ([QueryId])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectNotification_GetProjectNotificationsByUsername]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectNotification_CreateNewProjectNotification]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_AddUserToProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetRoadMap]'
GO
...
AS
SELECT 
	IssueId, IssueTitle, IssueDescription, IssueStatusId, IssuePriorityId, IssueTypeId, IssueCategoryId, BugNet_IssuesView.ProjectId, IssueResolutionId, 
	...
	LastUpdateUserId, ProjectName, ProjectCode, PriorityName, IssueTypeName, CategoryName, StatusName, ResolutionName, BugNet_IssuesView.MilestoneName, LastUpdateUserName, 
	...
	PriorityImageUrl, IssueTypeImageUrl, StatusImageUrl, BugNet_IssuesView.MilestoneImageUrl, ResolutionImageUrl, TimeLogged, IssueProgress, Disabled
FROM 
...
AND 
	IssueMilestoneId IN (SELECT DISTINCT IssueMilestoneId FROM BugNet_IssuesView WHERE IssueStatusId IN(SELECT StatusId FROM BugNet_ProjectStatus WHERE IsClosedState = 0 AND ProjectId = @ProjectId))
ORDER BY 
	PM.SortOrder DESC, IssueStatusId ASC,CategoryName ASC, IssueTypeName ASC, AssignedDisplayName ASC
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_GetCategoriesByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_CreateNewIssue]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Query_DeleteQuery]'
GO
CREATE PROCEDURE BugNet_Query_DeleteQuery 
  @QueryId Int
AS
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectNotification_DeleteProjectNotification]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_Delete]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueWorkReport_GetIssueWorkReportsByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueUserCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_GetIssuesByProjectIdAndCustomFieldView]'
GO
...
SELECT        dbo.BugNet_Issues.IssueId, dbo.BugNet_Issues.Disabled, dbo.BugNet_Issues.IssueTitle, ' ' AS IssueDescription, dbo.BugNet_Issues.IssueStatusId, 
                         ...
                         dbo.BugNet_Issues.IssueOwnerUserId, dbo.BugNet_Issues.IssueDueDate, dbo.BugNet_Issues.IssueMilestoneId, dbo.BugNet_Issues.IssueVisibility, 
                         ...
                         dbo.BugNet_Projects.ProjectName, dbo.BugNet_Projects.ProjectCode, dbo.BugNet_ProjectPriorities.PriorityName, 
                         dbo.BugNet_ProjectIssueTypes.IssueTypeName, dbo.BugNet_ProjectCategories.CategoryName, dbo.BugNet_ProjectStatus.StatusName, 
                         ISNULL(dbo.BugNet_ProjectMilestones.MilestoneName, N'none') AS MilestoneName, ISNULL(dbo.BugNet_ProjectResolutions.ResolutionName, 'none') 
                         ...
                         ISNULL(dbo.BugNet_ProjectResolutions.ResolutionImageUrl, '') AS ResolutionImageUrl, ISNULL
                             ((SELECT        SUM(Duration) AS Expr1
                                 FROM            dbo.BugNet_IssueWorkReports AS WR
                                 WHERE        (dbo.BugNet_Issues.IssueId = dbo.BugNet_Issues.IssueId)), 0.00) AS TimeLogged, dbo.BugNet_ProjectCustomFields.CustomFieldName, 
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Role_GetRolesByUser]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Query_SaveQuery]'
GO
CREATE PROCEDURE BugNet_Query_SaveQuery 
	@UserName NVarChar(255),
	@ProjectId Int,
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueComment_UpdateIssueComment]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetProjectMembers]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuesByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_GetRootCategoriesByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_RelatedIssue_GetParentIssues]'
GO
CREATE PROCEDURE BugNet_RelatedIssue_GetParentIssues
	@IssueId Int,
	@RelationType Int
AS
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueComment_GetIssueCommentById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueNotification_CreateNewIssueNotification]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_CreateNewProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectNotification_GetProjectNotificationsByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueAttachment_GetIssueAttachmentsByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelection_Update]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_RelatedIssue_GetRelatedIssues]'
GO
CREATE PROCEDURE BugNet_RelatedIssue_GetRelatedIssues
	@IssueId Int,
	@RelationType Int
AS
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_UpdateCategory]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelection_GetCustomFieldSelectionsByCustomFieldId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetChangeLog]'
GO
...
ORDER BY 
	IssueMilestoneId DESC,CategoryName ASC, IssueTypeName ASC, AssignedUserName ASC
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_UpdateProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuePriorityCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuesByOwnerUserName]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_RelatedIssue_GetChildIssues]'
GO
CREATE PROCEDURE BugNet_RelatedIssue_GetChildIssues
	@IssueId Int,
	@RelationType Int
AS
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuesByCreatorUserName]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_TimeEntry_GetWorkerOverallWorkReportByWorkerId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_User_GetUsersByProjectId]'
GO
...
JOIN
	BugNet_UserProjects
ON
	U.UserId = BugNet_UserProjects.UserId
JOIN 
	BugNet_UserProfiles
ON 
	U.UserName = BugNet_UserProfiles.UserName
WHERE
	BugNet_UserProjects.ProjectId = @ProjectId
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetRoadMapProgress]'
GO
...
(SELECT COUNT(*) FROM BugNet_IssuesView WHERE ProjectId = @ProjectId AND IssueMilestoneId = @MilestoneId) As TotalCount
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_GetChildCategoriesByCategoryId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetProjectById]'
GO
...
FROM 
	BugNet_Projects
	INNER JOIN aspnet_users AS Managers ON Managers.UserId = BugNet_Projects.ProjectManagerUserId	
	INNER JOIN aspnet_users AS Creators ON Creators.UserId = BugNet_Projects.ProjectCreatorUserId
WHERE
	ProjectId = @ProjectId
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueComment_GetIssueCommentsByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueWorkReport_CreateNewIssueWorkReport]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetPublicProjects]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetAllProjects]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomField_GetCustomFieldsByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_IsUserProjectMember]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_DeleteProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueHistory]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_BugNet_IssueHistory] on [dbo].[BugNet_IssueHistory]'
GO
ALTER TABLE [dbo].[BugNet_IssueHistory] ADD CONSTRAINT [PK_BugNet_IssueHistory] PRIMARY KEY CLUSTERED  ([IssueHistoryId])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueHistory_GetIssueHistoryByIssueId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelection_CreateNewCustomFieldSelection]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_TimeEntry_GetWorkReportByBugId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_TimeEntry_GetProjectWorkerWorkReport]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_CreateProjectMailbox]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueCategoryCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueUnassignedCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetProjectByCode]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssueStatusCountByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueAttachment_GetIssueAttachmentById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_TimeEntry_GetWorkReportByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetBugsByCriteria]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetMonitoredBugsByUser]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuesByAssignedUserName]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueHistory_CreateNewIssueHistory]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_RemoveUserFromProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetMailboxByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_IssueAttachment_CreateNewIssueAttachment]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_DeleteCategory]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_GetProjectByMailbox]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCategories_CreateNewCategory]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_ProjectCustomFieldSelection_DeleteCustomFieldSelection]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetRoadMap]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Issue_GetIssuesByRelevancy]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Query_GetQueriesByUserName]'
GO
CREATE PROCEDURE BugNet_Query_GetQueriesByUserName 
	@UserName NVarChar(255),
	@ProjectId Int
AS
DECLARE @UserId UNIQUEIDENTIFIER
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_RequiredFieldList]'
GO
CREATE TABLE [dbo].[BugNet_RequiredFieldList]
(
[RequiredFieldId] [int] NOT NULL IDENTITY(1, 1),
[FieldName] [nvarchar] (50) NOT NULL,
[FieldValue] [nvarchar] (50) NOT NULL
)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_BugNet_RequiredFieldList] on [dbo].[BugNet_RequiredFieldList]'
GO
ALTER TABLE [dbo].[BugNet_RequiredFieldList] ADD CONSTRAINT [PK_BugNet_RequiredFieldList] PRIMARY KEY CLUSTERED  ([RequiredFieldId])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_StringResources]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_BugNet_StringResources] on [dbo].[BugNet_StringResources]'
GO
ALTER TABLE [dbo].[BugNet_StringResources] ADD CONSTRAINT [PK_BugNet_StringResources] PRIMARY KEY CLUSTERED  ([resourceType], [cultureCode], [resourceKey])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetBugsByProjectId]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Resolution_GetAllResolutions]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Resolution_GetResolutionById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Type_GetTypeById]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Type_GetAllTypes]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Project_DeleteProjectMailbox]'
GO
SET QUOTED_IDENTIFIER OFF
GO
SET ANSI_NULLS OFF
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetChangeLog]'
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetRoadMapProgress]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[BugNet_Bug_GetRecentlyAddedBugsByProject]'
GO
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_Issues]'
GO
ALTER TABLE [dbo].[BugNet_Issues] WITH NOCHECK ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_RolePermissions]'
GO
ALTER TABLE [dbo].[BugNet_RolePermissions] WITH NOCHECK ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_ProjectMailBoxes]'
GO
ALTER TABLE [dbo].[BugNet_ProjectMailBoxes] WITH NOCHECK ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_IssueHistory]'
GO
ALTER TABLE [dbo].[BugNet_IssueHistory] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_ProjectCustomFields]'
GO
ALTER TABLE [dbo].[BugNet_ProjectCustomFields] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_Roles]'
GO
ALTER TABLE [dbo].[BugNet_Roles] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_UserRoles]'
GO
ALTER TABLE [dbo].[BugNet_UserRoles] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_RelatedIssues]'
GO
ALTER TABLE [dbo].[BugNet_RelatedIssues] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_ProjectCustomFieldSelections]'
GO
ALTER TABLE [dbo].[BugNet_ProjectCustomFieldSelections] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_ProjectCustomFieldValues]'
GO
ALTER TABLE [dbo].[BugNet_ProjectCustomFieldValues] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_IssueComments]'
GO
ALTER TABLE [dbo].[BugNet_IssueComments] ADD
...
PRINT N'Adding foreign keys to [dbo].[BugNet_RolePermissions]'
GO
ALTER TABLE [dbo].[BugNet_RolePermissions] ADD
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_IssueAttachments]'
GO
ALTER TABLE [dbo].[BugNet_IssueAttachments] ADD
...
PRINT N'Adding foreign keys to [dbo].[BugNet_Issues]'
GO
ALTER TABLE [dbo].[BugNet_Issues] ADD
...
CONSTRAINT [FK_BugNet_Issues_BugNet_ProjectCategories] FOREIGN KEY ([IssueCategoryId]) REFERENCES [dbo].[BugNet_ProjectCategories] ([CategoryId]) ON DELETE CASCADE,
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Adding foreign keys to [dbo].[BugNet_IssueNotifications]'
GO
ALTER TABLE [dbo].[BugNet_IssueNotifications] ADD
